...
public class RatingMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    private final Map<Integer, String> userGenders = new HashMap<>();
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        if (gender == null || title == null) return;

        context.write(new Text(title), new Text(String.format("G\t%s\tR\t%s", gender, rating)));
    }
